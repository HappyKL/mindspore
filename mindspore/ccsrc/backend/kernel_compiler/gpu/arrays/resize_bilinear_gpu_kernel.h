...
#ifndef MINDSPORE_CCSRC_BACKEND_KERNEL_COMPILER_GPU_RESIZE_BILINEAR_H_
#define MINDSPORE_CCSRC_BACKEND_KERNEL_COMPILER_GPU_RESIZE_BILINEAR_H_
...
class ResizeBilinearGpuKernel : public GpuKernel {
 public:
  ResizeBilinearGpuKernel() : align_corners_(false), shape_size_(0), input_size_(0), output_size_(0) {}
...
#endif  // MINDSPORE_CCSRC_BACKEND_KERNEL_COMPILER_GPU_RESIZE_BILINEAR_H_
